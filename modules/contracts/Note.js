...
Note.prototype.verify = function (trs, sender, cb, scope) {
...
Note.prototype.apply = function (trs, sender, cb, scope) {
...
Note.prototype.undo = function (trs, sender, cb, scope) {
...
Note.prototype.applyUnconfirmed = function (trs, sender, cb, scope) {
...
Note.prototype.undoUnconfirmed = function (trs, sender, cb, scope) {
	modules.blockchain.accounts.undoMerging({
		address: sender.address,
		u_balance: -trs.fee
	}, cb);
...
Note.prototype.ready = function (trs, sender, cb, scope) {
	setImmediate(cb);
}
...
Note.prototype.normalize = function (asset, cb) {
	setImmediate(cb);
}
...
Note.prototype.list = function (cb, query) {
	...
	library.validator.validate(query, {
		...
		}, ['id', 'type', 'senderId', 'senderPublicKey', 'recipientId', 'amount', 'fee', 'timestamp', 'signature', 'blockId', 'title', 'data', 'nonce', 'shared', 'transactionId'], function (err, notes) {
			if (err) {
